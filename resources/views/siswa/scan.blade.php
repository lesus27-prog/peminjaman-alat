...
@section('link')
    ...
    <style>
        .manual-group .btn-universal {
            transition: none !important;
            transform: none !important;
        }

        .manual-group .btn-universal:hover {
            transform: none !important;
                            ...
                            <div class="d-flex justify-content-between align-items-start pinjam-header">
                                ...
                                <div class="pinjam-left">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <strong style="font-size: 20px; font-weight: 800;" class="judul-scan">Alat Dipesan</strong>
                                    </div>
                                    ...
                                    <div class="small mt-1 text-scan">
                                        Batas Pengembalian:
                                        <strong>
                                            {{ \Carbon\Carbon::parse($peminjaman->tanggal_selesai . ' ' . $peminjaman->jam_selesai)->translatedFormat(
                                                'd F Y H:i',
                                            ) }}
                                        </strong>
                                    </div>
                            ...
                            <div id="peminjaman-checkpoint">
                                @foreach ($peminjaman->tipeAlat as $detail)
                                    <div class="inventory-item mb-3 px-3 py-2 rounded-3 border bg-white shadow-sm">
                                        ...
                                        <div class="code-box mt-1">
                                            <span class="label text-muted small scan-kode-alat ">Kode Alat</span>
                                            <div class="codes m-0"></div>
                                        </div>

                                        <div class="status-bar mt-1 alat-checkpoint" data-tipe="{{ $detail->nama_tipe }}">
...
@push('scripts')
    ...
    <script>
        @if (session('prosesPeminjamanScan_error'))
            toastr.error("{{ session('prosesPeminjamanScan_error') }}", "Terjadi Kesalahan", {
                timeOut: 5000,
                progressBar: true,
                closeButton: true
            });
